...
// API function for signup using Axios
...
const SignUp = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      // Use the mutation to handle signup
          ...
          <div className="relative z-10 flex flex-col justify-center h-full px-12">
            <div className="max-w-md">
              ...
              <p className="text-xl text-gray-700 mb-8">
                Join thousands of students who enjoy delicious meals, exclusive discounts, and a seamless ordering experience.
              </p>
